...
class InstrCov(mod: DefModule, mInfo: moduleInfo, extModules: Seq[String], val maxStateSize: Int = 14, val covSumSize: Int=18) {  //statesize表示regstatesize,covsum表示port的位宽
